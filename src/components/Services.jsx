          ...
          <div>
            <div style={{
              ...
              {servicesData.map((s, index) => (
                <div key={s.id} className="gold-card" style={{
                  display: 'flex',
              ...
              return (
                <div 
                  ...
                  style={{
                    ...
                    gap: '40px',
                    alignItems: 'center',
                    borderBottom: index !== servicesData.length - 1 ? '1px solid rgba(214, 175, 55, 0.1)' : 'none',
                    paddingBottom: index !== servicesData.length - 1 ? '60px' : '0'
                  }} 
                  className={`service-row ${isEven ? 'even-row' : 'odd-row'}`}
                >
